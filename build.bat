...
set ORDERS_FILES=barista_worker.cpp orders_manager.cpp
...
i686-w64-mingw32-g++.exe -std=c++11 -o bin\cafe.exe %BARISTA_FILES% %PRODUCTS_FILES% %ORDERS_FILES% %PARAM_FILES% cafe.cpp
